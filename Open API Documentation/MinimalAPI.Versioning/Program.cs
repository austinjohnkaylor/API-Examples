...
using OrderV1 = MinimalAPI.Versioning.Models.V1.Order;
using OrderV2 = MinimalAPI.Versioning.Models.V2.Order;
using OrderV3 = MinimalAPI.Versioning.Models.V3.Order;
using PersonV1 = MinimalAPI.Versioning.Models.V1.Person;
using PersonV2 = MinimalAPI.Versioning.Models.V2.Person;
using PersonV3 = MinimalAPI.Versioning.Models.V3.Person;
...
IVersionedEndpointRouteBuilder people = app.NewVersionedApi( "People" );

// 1.0
RouteGroupBuilder ordersV1 = orders.MapGroup( "/api/orders" )
...
ordersV1.MapPost( "/", ( HttpRequest request, OrderV1 order ) =>
         {
             ...
             Uri location = new Uri( $"{scheme}{Uri.SchemeDelimiter}{host}/api/orders/{order.Id}" );
...
// 2.0
RouteGroupBuilder ordersV2 = orders.MapGroup( "/api/orders" )
                     .HasApiVersion( 2.0 );
...
// 3.0
RouteGroupBuilder ordersV3 = orders.MapGroup( "/api/orders" )
                     .HasApiVersion( 3.0 );
...
// 1.0
RouteGroupBuilder peopleV1 = people.MapGroup( "/api/v{version:apiVersion}/people" )
                     .HasDeprecatedApiVersion( 0.9 )
                     .HasApiVersion( 1.0 );
...
// 2.0
RouteGroupBuilder peopleV2 = people.MapGroup( "/api/v{version:apiVersion}/people" )
                     .HasApiVersion( 2.0 );
...
// 3.0
RouteGroupBuilder peopleV3 = people.MapGroup( "/api/v{version:apiVersion}/people" )
                     .HasApiVersion( 3.0 );
...
peopleV3.MapPost( "/", ( HttpRequest request, ApiVersion version, PersonV3 person ) =>
         {
             ...
             string scheme = request.Scheme;
             HostString host = request.Host;
             Uri location = new Uri( $"{scheme}{Uri.SchemeDelimiter}{host}/v{version}/api/people/{person.Id}" );
